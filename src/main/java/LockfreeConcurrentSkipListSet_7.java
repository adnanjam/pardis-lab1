...
public class LockfreeConcurrentSkipListSet_7<T> {
    ...
    public LockfreeConcurrentSkipListSet_7() {
        for (int i = 0; i < head.next.length; i++) {
            head.next[i] = new AtomicMarkableReference<LockfreeConcurrentSkipListSet_7.Node<T>>(tail, false);
        }

    }

    public LockfreeConcurrentSkipListSet_7(int task) {
